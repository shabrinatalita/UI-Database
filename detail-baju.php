        ...
        <h3>Detail buku</he>
            <div class="box">
                ...
                <div class="col-2">
                    ...
                    <p><a href="https://api.whatsapp.com/send?phone=<?php echo $a->admin_telpon ?>&text=Saya ingin membeli baju anda." target="_blank">Hubungi Whatsapp Penjual <img src="img/WhatsApp-Logo (1).png" width="50px"></a></p>
                </div>
            </div>
        </div>
    </div>
